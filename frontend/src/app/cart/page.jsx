...
export default function CartPage() {
          ...
          <>
            ...
            <div className="flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:space-x-5 items-start">
              ...
              <div className="w-full lg:max-w-[505px] p-5 md:px-6 flex-col space-y-4 md:space-y-6 rounded-[20px] border border-black/10">
                ...
                <Button
    type="button"
    className="flex items-center justify-center text-sm md:text-base font-medium bg-black text-white rounded-full px-6 py-4 h-[54px] md:h-[60px] group transition-all"
  >
    <Link href="/CheckOut" className="flex items-center">
      Go to Checkout
      <FaArrowRight className="text-xl ml-2 group-hover:translate-x-1 transition-transform" />
    </Link>
  </Button>
  ...
  <Button
    type="button"
    className="flex items-center justify-center text-sm md:text-base font-medium bg-gray-200 text-gray-800 hover:bg-gray-300 rounded-full px-6 py-4 h-[54px] md:h-[60px] transition-all"
  >
