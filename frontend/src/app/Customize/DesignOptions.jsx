...
const [originalImageSrc, setOriginalImageSrc] = useState(null);
  ...
  if (file) {
    ...
    reader.onload = (event) => {
      ...
      // Save both original and editing image source
      setEditingImageSrc(imageUrl);
      setOriginalImageSrc(imageUrl); // Save the original image

      // Determine which image slot is being edited
  ...
  const handlePreviewMouseDown = (e, slot) => {
    ...
    const currentImage =
      slot === "first" ? firstUploadedImage : secondUploadedImage;
  ...
  return (
    <div className="p-2 bg-white w-64 h-full rounded-lg shadow-md">
      ...
      >
              ...
              <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                ...
                {showMore && (
                  <>
                    ...
                    <li>
                      Backgrounds will be removed; image prints in black.{" "}
                    </li>
                  </>
                )}
              </ul>
                    ...
                    >
                      <img
                        ...
                        style={{
                          ...
                          transform: `translate(${
                            ...
                            firstUploadedImage.position?.y || 0
                          }px) rotate(${
                      ...
                      <div
                        ...
                        style={{
                          ...
                          zIndex: 10,
                          opacity:
                            hoveredImageSlot === "first" ||
                            (isDraggingPreview && draggingImageSlot === "first")
                              ? 1
                              : 0,
                        }}
                      >
                  ...
                  {/* {firstUploadedImage && (
                    <div className="flex justify-center mt-1 space-x-2">
                      <button
                        ...
                        className="rounded-full bg-blue-600 text-white shadow-md hover:shadow-lg transition duration-200"
                      >
                        <i
                          style={{ fontSize: "14px" }}
                      ...
                      <button
                        ...
                        style={{ padding: "0px 6px" }}
                        className="rounded-full bg-red-600 text-white shadow-md hover:bg-red-700 hover:shadow-lg transition duration-200"
                      >
                        <i
                          style={{ fontSize: "14px" }}
                    ...
                    >
                      <img
                        ...
                        style={{
                          ...
                          transform: `translate(${
                            ...
                            secondUploadedImage.position?.y || 0
                          }px) rotate(${
                      ...
                      <div
                        ...
                        style={{
                          ...
                          zIndex: 10,
                          opacity:
                            hoveredImageSlot === "second" ||
                            (isDraggingPreview &&
                              draggingImageSlot === "second")
                              ? 1
                              : 0,
                        }}
                      >
        ...
        {showImageEditor && (
          <div ref={editorRef} className="mt-0 p-4 border rounded-md shadow-md">
    ...
    <img src={originalImageSrc} alt="Original" />
            ...
            <div className="flex items-center space-x-2">
              ...
              <p className="text-center">
                Click anywhere to position image or drag to move
              </p>
            </div>
        ...
        {showTextFields && (
          <div
            id="select-text"
            className="mt-0 p-4 border rounded-md shadow-md"
          >
